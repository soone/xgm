<?php /* Smarty version Smarty3-b8, created on 2010-11-27 02:16:20
         compiled from "/media/work_study/work/soone/xgm/./Www/template/default/Good_gowrongin.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18266455164ceff9740aa4b4-81221754%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '18266455164ceff9740aa4b4-81221754',
  'function' => 
  array (
  ),
...
?>
	<tr>
		...
		<td>
			<input type="text" name="yll[<?php echo $_smarty_tpl->getVariable('orderInfo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['s']['index']][0];?>
]" disabled="disabled" value="<?php echo $_smarty_tpl->getVariable('orderInfo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['s']['index']][3];?>
" class="text" style="width:50px;" />
			<input type="hidden" name="yl[<?php echo $_smarty_tpl->getVariable('orderInfo')->value[$_smarty_tpl->getVariable('smarty')->value['section']['s']['index']][0];?>
