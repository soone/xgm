<?php /* Smarty version Smarty3-b8, created on 2010-06-15 15:20:28
         compiled from "/media/work_study/work/soone/xgm/./Www/template/default/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14239700544c1729bc84baa4-93659210%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14239700544c1729bc84baa4-93659210',
  'function' => 
  array (
  ),
   ...
   <div class="rMenuInfo">你好，西瓜猫！密码修改|登出</div>
    <div id="menu">
        <div>
            <h4>供货商管理</h4>
            <ul>
                <li><a href="">供货商添加</a></li>
                <li><a href="">供货商列表</a></li>
            </ul>
        </div>
        <div>
            <h4>礼品卡管理</h4>
            <ul>
                <li><a href="">礼品卡定义</a></li>
                <li><a href="">礼品卡列表</a></li>
                <li><a href="">卡外观定义</a></li>
            </ul>
        </div>
        <div>
            <h4>销售管理</h4>
            <ul>
                <li><a href="">售卡订单登记</a></li>
                <li><a href="">订单列表</a></li>
                <li><a href="">出卡操作</a></li>
