<?php /* Smarty version Smarty3-b8, created on 2010-06-21 01:38:29
         compiled from "/media/work_study/work/soone/xgm/./Www/template/default/Card_search.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3577800234c1e52154f71a2-66780678%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3577800234c1e52154f71a2-66780678',
  'function' => 
  array (
  ),
...
" />&nbsp;&nbsp;
	...
	<?php if (($_smarty_tpl->getVariable('card')->value[6]==3||($_smarty_tpl->getVariable('card')->value[9]>0&&$_smarty_tpl->getVariable('cType')->value[6]==1))&&$_smarty_tpl->getVariable('card')->value[5]==1){?>
	<h5>点击<a href="index.php?control=card&action=choose&clnum=<?php echo $_smarty_tpl->getVariable('card')->value[3];?>
&clid=<?php echo $_smarty_tpl->getVariable('card')->value[1];?>
&blance=<?php echo $_smarty_tpl->getVariable('card')->value[9];?>
">这里</a>开始挑选客户需要的物品</h5>
	<?php }?>
	<table class="slist">
		<tr>
