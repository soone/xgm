...
<?php /*%%SmartyHeaderCode:470658454c26af662d12b9-19226111%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '470658454c26af662d12b9-19226111',
  'function' => 
  array (
  ),
...
<div class="divform">
  <form action="index.php" method="POST">
  	<p>
      	<label>进货单号：</label><input type="text" name="comname" class="text" value="<?php echo $_smarty_tpl->getVariable('info')->value[0];?>
" style="width:120px;" />&nbsp;&nbsp;
		<label>总价：</label><input value="<?php echo $_smarty_tpl->getVariable('info')->value[1];?>
