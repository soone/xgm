<?php /* Smarty version Smarty3-b8, created on 2010-07-17 04:06:21
         compiled from "/media/work_study/work/soone/xgm/./Www/template/default/Good_orderlist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17287529854c40bbbd26b8a8-50168098%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17287529854c40bbbd26b8a8-50168098',
  'function' => 
  array (
  ),
...
?>
		<tr>
			...
			<td><?php if ($_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][4]==1){?>储物卡配送单<?php }elseif($_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][4]==2){?>储值卡配送单<?php }elseif($_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][4]==3){?>零散配送单<?php }elseif($_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][4]==4){?>补送配送单<?php }elseif($_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][4]==5){?>投诉补送配送单<?php }?></td>
