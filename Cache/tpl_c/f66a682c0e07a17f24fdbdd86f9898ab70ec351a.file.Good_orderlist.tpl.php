...
?>
		<tr>
			<td><?php if ($_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][8]){?>卡号：<?php echo $_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][8];?>
<?php }else{ ?><?php echo $_smarty_tpl->getVariable('golist')->value[$_smarty_tpl->getVariable('smarty')->value['section']['l']['index']][1];?>
<?php }?></td>
