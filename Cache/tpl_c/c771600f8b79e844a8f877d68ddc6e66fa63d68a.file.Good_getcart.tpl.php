<?php /* Smarty version Smarty3-b8, created on 2010-07-12 23:59:38
         compiled from "/media/work_study/work/soone/xgm/./Www/template/default/Good_getcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17626887874c3b3bead40ed8-72418303%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17626887874c3b3bead40ed8-72418303',
  'function' => 
  array (
  ),
...
$(document).ready(function(){
	...
	if(pInfo)
	{
        ...
        p += parseInt(pInfo['otype']) == 3 ? '<th>折扣率：</th><td><input type="text" class="text" style="width:40px;" id="cuttax" value="'+pInfo['total']+'" />%</td><td colspan="3"></td>' : '<td colspan="5"></td>';
        p += '</tr><tr><th>收货人信息：</th><td colspan="5">';
        if(pInfo['ou_gadr'] != null)
        {
        	pAdd = pInfo['ou_gadr'];
        ...
        p += '<tr><th>收费备注：</th><td colspan="2"><select><option value="0">请选择收款方式</option><option value="1">司机代收</option><option value="2">支付宝收款</option><option value="3">其他方式</option></select><br /><textarea name="gmark" style="width:200px;height:150px;"></textarea></td>';
