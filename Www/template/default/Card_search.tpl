...
<div class="divform">
	...
	<h5>点击<a href="index.php?control=good&action=order&clnum=<!--{$card[3]}-->&clid=<!--{$card[1]}-->&balance=<!--{$card[9]}-->">这里</a>开始登记配送单信息</h5>
	<!--{/if}-->
	<table class="slist">
		<tr>
			<td><b>卡号</b></td>
			...
			<td><!--{$card[9]}--></td>
			<td><b>卡状态</b></td>
			<td><!--{if $card[5] == 1}-->可用<!--{else}-->不可用<!--{/if}--><!--{if $card[6] == '0000-00-00 00:00:00'}-->(未出卡)<!--{/if}--></td>
			<td><b>卡名称</b></td>
			<td><!--{$cType[1]}--></td>
			<td><b>卡类型</b></td>
