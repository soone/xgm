...
$(document).ready(function(){
	...
	if(pInfo)
	{
        ...
        p += '<tr><th>收费备注：</th><td colspan="2"><textarea name="gmark" style="width:200px;height:150px;"></textarea></td>';
	...
	else
	{
		...
		if(allPrice > 0)
		{
			...
			$('#sc').html(tCont);
			var lMoney = cInfo['balance'] - allPrice
